...
<body>
	...
	<div class="row">
                            <a href="APP/controler.php?opcion=1">
                            ...
                            <a href="APP/controler.php?opcion=2" name="cursos" id="cursos" >
                            ...
                            <a href="APP/controler.php?opcion=3" >
                            ...
                            <a href="APP/controler.php?opcion=4" >
                            <div class="col-md-2 col-sm-3 col-xs-12 center content_" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInLeft;">
